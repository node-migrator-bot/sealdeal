(function() {
  var build, compileCSSFile, compileCoffeeFileTo, compileFile, compileHTMLFile, compileJSDir, compileJSFile, concatCSSDir, concatFiles, concatJSDir, copyTree, cssExtensions, cssFilter, extensionRegex, extractJSRequires, extractRequires, fileConfig, fileType, fs, getCompiler, getFiles, htmlExtensions, htmlFilter, isInsideDir, itemToLast, jsExtensions, jsFilter, mkdirRecursive, path, readFile, readHTMLPage, regexFilter, removeExt, requireCompiler, walk, writeFileRecursive, _;
